...
func seedSmartAmbient() func() {
	restoreI := items.SeedItemsForTest(map[int]*items.ItemSpec{
		...
		999956: {ItemId: 999956, Name: "renewal potion", Type: items.Potion, ConditionIds: []int{55}},
	})
	restoreB := conditions.SeedConditionsForTest(map[int]*conditions.ConditionSpec{
		54: {ConditionId: 54, Name: "Vigor", Description: "vigor", RoundInterval: 5, TriggerCount: 100},
		55: {ConditionId: 55, Name: "Renewal", Description: "renewal", RoundInterval: 5, TriggerCount: 100},
	})
