...
func Consume(rest string, mob *mobs.Mob, room *rooms.Room) (bool, error) {
	...
	if isGolem {
		...
		_ = mob.Character.AddBuffMagnitude(conditions.BuffIdRegenerating, 10, 3.0, "grafted corpse")
		...
		_ = mob.Character.AddBuffMagnitude(conditions.BuffIdRegenerating, 6, 2.0, "consumed corpse")
		room.SendTextVisual(messaging.CategoryMobIdle,
