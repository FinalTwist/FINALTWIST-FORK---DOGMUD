...
// GetAllyAuraConditions returns the buff ids that owned mutations project onto
...
// GetEnemyAuraConditions returns the debuff ids that owned mutations project onto
