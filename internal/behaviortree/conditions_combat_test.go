...
func TestTargetPowerRatio_AggroMobFallback(t *testing.T) {
	...
	specs := map[int]*mobs.Mob{
		5:  {MobId: mobs.MobId(5), Character: characters.Character{Name: "StrongMob", Buffs: conditions.New()}},
		10: {MobId: mobs.MobId(10), Character: characters.Character{Name: "WeakTargetMob", Buffs: conditions.New()}},
	}
	instances := map[int]*mobs.Mob{
		105: {MobId: mobs.MobId(5), InstanceId: 105, HomeRoomId: 1,
			Character: characters.Character{Name: "StrongMob", Buffs: conditions.New()}},
		110: {MobId: mobs.MobId(10), InstanceId: 110, HomeRoomId: 1,
			Character: characters.Character{Name: "WeakTargetMob", Buffs: conditions.New()}},
	}
