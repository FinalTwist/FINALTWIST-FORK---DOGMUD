...
var u8HelpExceptions = map[string]string{
	...
	"help/carapace-ward":      "spell/condition reference card: cast time and reserve are its content",
	"help/chitin-brace":       "spell/condition reference card: cast time and reserve are its content",
	"help/chrysalis-bond":     "spell/condition reference card: cast time and reserve are its content",
	"help/chrysalis-sight":    "spell/condition reference card: cast time and reserve are its content",
	"help/chrysalis-stride":   "spell/condition reference card: cast time and reserve are its content",
	"help/firebomb":           "spell/condition reference card: cast time and reserve are its content",
	"help/flashbang":          "spell/condition reference card: cast time and reserve are its content",
	"help/honed-edge":         "spell/condition reference card: cast time and reserve are its content",
	"help/hungering-touch":    "spell/condition reference card: cast time and reserve are its content",
	"help/ironblood":          "spell/condition reference card: cast time and reserve are its content",
	"help/mindweave":          "spell/condition reference card: cast time and reserve are its content",
	"help/predators-instinct": "spell/condition reference card: cast time and reserve are its content",
	"help/rootbind":           "spell/condition reference card: cast time and reserve are its content",
	"help/rootwalker":         "spell/condition reference card: cast time and reserve are its content",
	"help/serpents-edge":      "spell/condition reference card: cast time and reserve are its content",
	"help/shadowweave":        "spell/condition reference card: cast time and reserve are its content",
	"help/spore-mantle":       "spell/condition reference card: cast time and reserve are its content",
	"help/sporeweave":         "spell/condition reference card: cast time and reserve are its content",
	"help/thornguard":         "spell/condition reference card: cast time and reserve are its content",
	"help/toxic-flask":        "spell/condition reference card: cast time and reserve are its content",
	"help/venomgrip":          "spell/condition reference card: cast time and reserve are its content",
