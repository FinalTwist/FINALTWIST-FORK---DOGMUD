...
the module has is documented with its default in
`modules/aicompanion/files/data-overlays/config.yaml`, and any of them can be
overridden in the same block.
