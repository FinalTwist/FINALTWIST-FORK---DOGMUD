...
```bash
git mv docs/superpowers/specs/completed/2026-05-25-mob-aliveness-3.3-sleeping-wake-states-design.md docs/superpowers/specs/completed/
git mv docs/superpowers/plans/completed/2026-05-25-mob-aliveness-3.3-sleeping-wake-states.md docs/superpowers/plans/completed/
```
