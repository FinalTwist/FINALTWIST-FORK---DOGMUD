...
| 35 | Parry counter lines are blade-shaped ("cut back", "a clean cut", "drive the point home", "opening {actor}'s arm") in about three of five variants per band, but parry needs any non-fist weapon, so a mace or staff parry reads oddly most of the time | 27 of 45 lines in `counter-parry.yaml` name a cut, point or blade action | none; content only | Counters slice final review, 2026-09-18 | Owner ruling 4 licensed parry as "steel on steel"; a weapon-agnostic re-tone (turn, check, drive, strike) is an M6 copy pass, not a mechanism change | open |
