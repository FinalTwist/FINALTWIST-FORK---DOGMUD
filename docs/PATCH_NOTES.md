...
kind of harm it does, and how many it reaches, and every spell file says the
same three things. The defences that may answer an attack are read from one
